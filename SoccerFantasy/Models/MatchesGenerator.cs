                ...
                foreach (Team awayTeam in teams.Where(t => t.name != homeTeam.name))
                {
                    ...
                    if (availableDates.Any())
                    {
                        ...
                        Match match = new Match
                        {
                            ...
                            awaySubPlayers = awaySubs,
                            homeStartingPlayers = homeStarters,
                            homeSubPlayers = homeSubs
                        };
...
//    {
//        Team homeTeam = availableTeams[random.Next(0, availableTeams.Count)];
//        availableTeams.Remove(homeTeam);
//        Team awayTeam = availableTeams[random.Next(0, availableTeams.Count)];
